    ...
    <div className="border p-7 rounded-xl shadow-sm mt-3">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
        <div className="flex gap-2">
          ...
          <div>
            <h2 className="text-xs text-gray-500">Рівень Знань</h2>
        ...
        <div className="flex gap-2">
          ...
          <div>
            <h2 className="text-xs text-gray-500">Тривалість</h2>
        ...
        <div className="flex gap-2">
          ...
          <div>
            <h2 className="text-xs text-gray-500">Розділи</h2>
            <h2 className="font-medium text-lg">
        ...
        <div className="flex gap-2">
          ...
          <div>
            <h2 className="text-xs text-gray-500">Додати Відео</h2>
